...
from src.exceptions import InvalidScopeName, CException, BadMBCSPath, NotPythonSource, BadArgument, ThreadNotFound, \
    NoThreads, ThreadDone, DebuggerNotBroken, InvalidFrame, NoExceptionFound, CConnectionException, FirewallBlock, \
